...
if ejercicio == "1":
    ...
    saludo = "¡Bienvenido, " + "estudiante " + "de " + "Python!"
    print(saludo)       
    pass 
...
# --- Ejercicio 6 ---
    ...
    nombre_edad=[" Nombre: Ana "+" - "+" Edad: 21 años "]
    print(nombre_edad)
    pass
...
# --- Ejercicio 10 ---
    ...
    total_segundos = años * segundos_por_año
    print(f"En {años} años hay {total_segundos} segundos.")
    pass
